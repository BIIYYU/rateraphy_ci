			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						...
						<h3 class="text-center mb-4"><label style="font-weight:bold">Login</label>
							<img src="<?php echo base_url('assets_admin/img/logo.png') ?>" width="350" height="230"
								align="center" /></h3>
						<!-- <img src="<?php echo base_url('assets_admin/img/logo.png') ?>" width="350" height="230" align="center"/> -->
						<form method="post" action="<?= base_url('login/act_login') ?>">
							...
							<div class="form-group d-flex">
								<input type="password" class="form-control rounded-left" placeholder="Password"
									name="pass" value="admin" required>
							</div>
							<div class="form-group">
								<button type="submit"
