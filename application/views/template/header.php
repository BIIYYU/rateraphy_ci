    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <h3 style="font-weight: bold; color: white; text-align: center;">RaTeraphy</h3>
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          if ($this->session->role == 'kasir') {
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>utama/pembelian" class="nav-link">
                ...
                <p>Data Penjualan<span class="badge badge-info right"></span></p>
              </a>
            </li>
          <?php }elseif ($this->session->role =='admin') { ?>
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>utama/item/" class="nav-link">
                ...
                <p>Data Item<span class="badge badge-info right"></span></p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url() ?>utama/pembelian" class="nav-link">
                <i class="nav-icon fas fa-shopping-bag"></i>
                <p>Data Pembelian<span class="badge badge-info right"></span></p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url() ?>utama/user" class="nav-link">
                <i class="nav-icon fas fa-users"></i>
                <p>Data<span class="badge badge-info right"></span></p>
              </a>
            </li>
          <?php } else{ ?>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>utama/penjualan" class="nav-link">
                ...
                <p>Penjualan<span class="badge badge-info right"></span></p>
             </a>
           </li>
           <li class="nav-item">
            <a href="<?= base_url() ?>utama/kasir" class="nav-link">
              <i class="nav-icon fas fa-user-tie"></i>
              <p>Kasir<span class="badge badge-info right"></span></p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>utama/data_penjualan" class="nav-link">
              <i class="nav-icon fas fa-shopping-bag"></i>
              <p>Data Order<span class="badge badge-info right"></span></p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url() ?>utama/data_produk" class="nav-link">
              <i class="nav-icon fas fa-shopping-basket "></i>
              <p>Data Produk<span class="badge badge-info right"></span></p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url() ?>utama/data_pelanggan" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p>Data Pelanggan<span class="badge badge-info right"></span></p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url() ?>utama/data_user" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>Data Admin<span class="badge badge-info right"></span></p>
            </a>
          </li>
        <?php } ?>
      </ul>
