<link href='https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.8.0/fullcalendar.print.css' rel='stylesheet'
	media='print' />
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											<tr>
												<td><?= $no++ ?></td>
												<td>
													<select class="form-control text-center" id="barang<?= $i ?>"
														name="barang[]">
														<option value="">-- Pilih Produk --</option>
														<?php foreach ($produk as $data) { ?>
														<option value="<?= $data['id'] ?>"><?= $data['nama_produk'] ?>
														</option>
														<?php } ?>
													</select>
												</td>
												...
												<td>
													<p><input type="number" name="qty[]" class="text-center"
															id="qty<?= $i ?>"></p>
												</td>
												<td>
